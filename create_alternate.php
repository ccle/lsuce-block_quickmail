...
$PAGE->set_url(new moodle_url('/blocks/quickmail/create_alternate.php', $pageparams));
...
//     new moodle_url('/blocks/quickmail/qm.php', array('courseid' => $pageparams['course_id'])));
